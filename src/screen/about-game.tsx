    ...
    return (
        <MainLayout needProtection={false}>
            <div className="w-full min-h-screen flex flex-col items-center justify-start bg-gradient-to-b from-emerald-50 to-emerald-100 text-gray-800">
                ...
                {/* Story Section */}
                <section className="bg-[#00081a] text-white mx-auto px-6 py-16 text-center">
                <h2 className="text-3xl font-bold mb-6 text-emerald-700">
                    From Fields to Fortune
                </h2>
                <p className="text-lg leading-relaxed text-white">
                    In the land of <strong>Godean</strong>, every seed you plant shapes not
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="bg-[#00081a] text-white p-6 rounded-2xl shadow hover:shadow-md transition">
                ...
                {/* Vision Section */}
                <section className="bg-[#00081a] mx-auto px-6 py-16 text-center">
                <h2 className="text-3xl font-bold mb-6 text-emerald-700">
                    Our Vision
                </h2>
                <p className="text-lg leading-relaxed text-white">

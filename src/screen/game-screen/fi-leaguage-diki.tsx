...
import FisimHowToInvestGame from "../../game-sources/scene/fisim-how-to-invest-game";

export default function FinanceLeagueDoIKnowInvestmentGameScreen() {
